...
public class Room {
    ...
    public Room(int id, String name, String difficulty, double price, int theme_id) {
        this.id = id;
        this.name = name;
    ...
    public static Room fromDatabase(RoomDTO dto) {
        return new Room(dto.id(), dto.name(), dto.difficulty(), dto.price(), dto.themeId());
    }
    ...
    public RoomDTO toDTO() {
        return new RoomDTO(id, name, difficulty, price, theme_id);
    }
    ...
    public Room createNewInstanceWithName(String newName) {
        return new Room(this.id, newName, this.difficulty, this.price, this.theme_id);
    }

    public Room createNewInstanceWithPrice(double newPrice) {
        return new Room(this.id, this.name, this.difficulty, newPrice, this.theme_id);
    }

    public Room createNewInstanceWithEscapeRoomId(int newEscapeRoomId) {
        return new Room(this.id, this.name, this.difficulty, this.price, newEscapeRoomId);
    }
